...
CLMsgLoopManagerForMsgQueue::CLMsgLoopManagerForMsgQueue(CLMessageObserver *pMsgObserver, const char* pstrThreadName, CLMessageQueue *m_cpMsgQueue) : CLMessageLoopManager(pMsgObserver)
{
	m_strThreadName = pstrThreadName;

	m_pMsgQueue = m_cpMsgQueue;
}
